...
namespace FunWithLinqExpressions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (object o in objs) { Console.WriteLine(o); }    //  Calls ToString() on each anonymous object.
            Console.WriteLine();
        ...
        static void SelectEverything(ProductInfo[] products)
        {
            ...
            foreach (var prod in allProducts) { Console.WriteLine(products.ToString()); }
        }
        ...
        static void ReverseEverything(ProductInfo[] products)
        {
            ...
            var allProducts = from p in products select p;
            foreach (var prod in allProducts.Reverse()) { Console.WriteLine(prod.ToString()); }
        }
        ...
        static void AlphabetizeProductNames(ProductInfo[] products)
        {
            ...
            foreach (var p in subset) { Console.WriteLine(p.ToString()); }
        }
